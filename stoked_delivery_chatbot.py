{
  ...
  "metadata": {
    "colab": {
      "provenance": [],
      "authorship_tag": "ABX9TyPCVyR6srwMAp6jj2qjqto/",
  ...
  "cells": [
    {
      ...
      "source": [
        "<a href=\"https://colab.research.google.com/github/botvoodoo/Blockchain-Management-Office/blob/main/stoked_delivery_chatbot.py\" target=\"_parent\"><img src=\"https://colab.research.google.com/assets/colab-badge.svg\" alt=\"Open In Colab\"/></a>"
      ]
    },
    {
      "cell_type": "code",
    ...
    },
    {
      ...
      "metadata": {
        ...
        "id": "VXWktwD0hxh5",
        "outputId": "020accce-a4cb-47b5-b2cc-a4faf45d5237"
      },
      "execution_count": 8,
      "outputs": [
        {
          ...
          "text": [
            ...
            "Requirement already satisfied: markdown-it-py>=2.2.0 in /usr/local/lib/python3.10/dist-packages (from rich<14,>=10.14.0->streamlit) (2.2.0)\n",
    ...
    },
    {
      ...
      "metadata": {
        ...
        "id": "fb2U_leDc2Za",
        "outputId": "5938b647-acf7-464f-c8dd-9eebc97fe294"
      },
      "execution_count": 5,
      "outputs": [
        {
          ...
          "name": "stdout",
          "text": [
            "Response from Model: If you need to change the delivery address after placing an order, please contact us as soon as possible. We may be able to make the change, but it depends on the status of your order.\n"
          ]
        }
      ]
    },
